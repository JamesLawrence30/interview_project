...
void cleanup_consumed_message(amqp_envelope_t* envelope) {
    amqp_destroy_envelope(envelope);
}
void cleanup_consumed_message(amqp_envelope_t* envelope, amqp_connection_state_t rabbitmq) {
    cleanup_consumed_message(envelope);
    amqp_maybe_release_buffers(rabbitmq);
}

amqp_rpc_reply_t consume(amqp_connection_state_t& rabbitmq, amqp_envelope_t* envelope) {
